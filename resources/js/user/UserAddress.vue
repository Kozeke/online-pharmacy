  ...
  <div class="address_main" v-if="$route.path == '/userAddress'">
    <div class="personal_info">
      ...
      <div class="detail">
        <div v-if="!do_change" class="infos">
          ...
          <div class="form-group row">
            ...
            <div class="col-8 form-select">
              <span class="col-form-info">{{user_place.length===3?user_place[1][0]:user_place[0]}}</span>
            </div>
          </div>
          <div v-if="user_place.length===3" class="form-group row">
            <label class="col-4 col-form-label">Населенный пункт</label>
            <div class="col-8 form-select">
              <span class="col-form-info">{{user_place[0]}}</span>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-8 form-select">
              ...
              <span class="col-form-info" v-else>{{user_address}}</span>
            </div>
          </div>
        </div>
        <div v-else class="infos">
          <div class="form-group row">
            ...
            <div class="col-8 form-select">
              ...
              <span class="col-form-info" v-else>
                {{ user_place.length === 2?
          ...
          <div v-if="selected_region" class="form-group row">
            <label class="col-4 col-form-label">Районы/Город</label>
            <div class="col-8 form-select">
              <select class="form-control" v-model="selected_district" v-if="do_change">
                <option
          ...
          <div class="form-group row">
            ...
            <div class="col-8 form-select">
              ...
              <!-- </select> -->
              <input class="form-control" type="text" v-model="selected_address" v-if="do_change">
      ...
      <div class="make_change" v-if="do_change">
        ...
        <a class="save" v-on:click="updateLocality()">Сохранить</a>
      </div>
