        ...
        <div class="section_text">
          <div class="text_body">
            ...
            <div class="text_bottom">
              <h4>{{product.count}} {{product.volume}}</h4>
            </div>
            <div class="product_features">
              ...
              <div class="access">
                ...
                <span v-if="product.count">В наличии</span>
          ...
          <div class="product_counter">
            <h4>{{product.price_with_discount}} тг.</h4>
            <div class="do_change">
              ...
              <div class="remove">
                <span span @click="Remove(product.id)">Удалить</span>
  ...
  methods: {
    ...
    Remove(id) {
      ...
      Swal.fire({
        ...
        text: "Вы уверены что хотите удалить препарат?",
        type: "warning",
    ...
    getLocality(product) {
      console.log("get products locality called", product);
      let _this = this;
      _this.user_place = "";
...
@font-face {
  ...
  src: url(/css/montserrat/Montserrat-Medium.otf);
}
.body_content {
  display: flex;
