      ...
      >
        ...
        <div class="col-9">
          <textarea
            class="form-control"
            type="text"
            v-model="update_product.free_shipping"
            placeholder="введите несколько строчек"
          ></textarea>
          <form-error
        ...
        post(
          ...
          "/api/pharm/products/create",
          {
            ...
            locality_id: _this.selected_locality
              ...
              : "",
            district_id: _this.selected_district.id,
